...
if (CTI_POPO_TOWN_Hostages_Georgetown_ENABLED isEqualTo CTI_POPO_TOWN_Hostages_Georgetown_ENABLED) then {[Hostage,20,"hostages_marker_area_0", 400] spawn POPO_Common_fnc_SpawnRandomHostagesBuilding;};
...
if (CTI_POPO_TOWN_Units_Georgetown_ENABLED isEqualTo 1) then {[Units_Resistance,400,"units_marker_area_0", 400] call POPO_Server_fnc_SpawnUnitRandomBuilding;};
