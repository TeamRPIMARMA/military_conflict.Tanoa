...
/*
  ...
  # SYNTAX #
    ["_ArraySpawn", "_type", "_number"] call POPO_fnc_reinforcementVehicle;

  # DEPENDENCIES # 
    call POPO_fnc_SkillSet

  # EXAMPLE # 
    [independent_Random_Spawn_vehicle,independent_ReinforcementVehicle ,2] call POPO_fnc_reinforcementVehicle;
*/
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
for "_i" from 1 to _number do { // -- On répète X fois le code pour X véhicules
    ...
    [_crew,SYNDIKAT_LIGskill] call POPO_fnc_SkillSet;
